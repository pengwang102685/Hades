...
import './../component_css/Samsara.css';
class Samsara extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      awards: [
        {id: 1, name: '畜生', level: '1', color:"#0099ff"},
        {id: 2, name: '恶鬼', level: '2', color:"#ff6666"},
        {id: 3, name: '阿修罗',level: '3', color:"#FFE122"},
        {id: 4, name: '天道', level: '4', color:"#0099ff"},
        {id: 5, name: '人道', level: '5', color:"#ff6666"},
        {id: 6, name: '地狱', level: '6', color:"#FFE122"},
      ],//大转盘的奖品列表
      animation: true,
